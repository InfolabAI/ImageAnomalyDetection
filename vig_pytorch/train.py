...
from timm.data import resolve_data_config, Mixup, FastCollateMixup, AugMixDataset  # , Dataset
import vig
import pyramid_vig
...
from torchvision import datasets as PTdatasets
...
def main():
    ...
    if args.distributed:
        ...
        torch.distributed.init_process_group(
            backend='nccl', init_method=args.init_method, rank=args.rank, world_size=args.world_size)
    ...
    # get torch.dataset.Dataset from train_dir
    dataset_train = PTdatasets.ImageFolder(train_dir)
